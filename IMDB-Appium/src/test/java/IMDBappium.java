...
public class IMDBappium {
	...
	final String user = "Krishnaraj.Kaliyamoorthy@wyn.com";
	final String pass = "Perfecto123";
	final String host = "wyn.perfectomobile.com";
	...
	public void Search() throws InterruptedException{
		//Search bar.
		driver.findElement(By.xpath(AppObjects.newReminder)).click();
...
//			driver.findElement(By.xpath(AppObjects.MoviePath)).click();
			...
			driver.findElement(By.xpath(AppObjects.newReminder)).click();
			driver.getKeyboard().sendKeys("Test for Appium Script");
